...
export function useUpsertCustomer(options?: useDataConnectMutationOptions<UpsertCustomerData, FirebaseError, UpsertCustomerVariables>): UseMutationResult<FlattenedMutationResult<UpsertCustomerData, UpsertCustomerVariables>, FirebaseError, UpsertCustomerVariables>;
export function useUpsertCustomer(dc: DataConnect, options?: useDataConnectMutationOptions<UpsertCustomerData, FirebaseError, UpsertCustomerVariables>): UseMutationResult<FlattenedMutationResult<UpsertCustomerData, UpsertCustomerVariables>, FirebaseError, UpsertCustomerVariables>;

export function useCreateProductReview(options?: useDataConnectMutationOptions<CreateProductReviewData, FirebaseError, CreateProductReviewVariables>): UseMutationResult<FlattenedMutationResult<CreateProductReviewData, CreateProductReviewVariables>, FirebaseError, CreateProductReviewVariables>;
export function useCreateProductReview(dc: DataConnect, options?: useDataConnectMutationOptions<CreateProductReviewData, FirebaseError, CreateProductReviewVariables>): UseMutationResult<FlattenedMutationResult<CreateProductReviewData, CreateProductReviewVariables>, FirebaseError, CreateProductReviewVariables>;

export function useCreateOrder(options?: useDataConnectMutationOptions<CreateOrderData, FirebaseError, CreateOrderVariables>): UseMutationResult<FlattenedMutationResult<CreateOrderData, CreateOrderVariables>, FirebaseError, CreateOrderVariables>;
export function useCreateOrder(dc: DataConnect, options?: useDataConnectMutationOptions<CreateOrderData, FirebaseError, CreateOrderVariables>): UseMutationResult<FlattenedMutationResult<CreateOrderData, CreateOrderVariables>, FirebaseError, CreateOrderVariables>;

export function useUpdateOrderByPaymentIntentId(options?: useDataConnectMutationOptions<UpdateOrderByPaymentIntentIdData, FirebaseError, UpdateOrderByPaymentIntentIdVariables>): UseMutationResult<FlattenedMutationResult<UpdateOrderByPaymentIntentIdData, UpdateOrderByPaymentIntentIdVariables>, FirebaseError, UpdateOrderByPaymentIntentIdVariables>;
export function useUpdateOrderByPaymentIntentId(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateOrderByPaymentIntentIdData, FirebaseError, UpdateOrderByPaymentIntentIdVariables>): UseMutationResult<FlattenedMutationResult<UpdateOrderByPaymentIntentIdData, UpdateOrderByPaymentIntentIdVariables>, FirebaseError, UpdateOrderByPaymentIntentIdVariables>;

export function useUpdateOrderByChargeId(options?: useDataConnectMutationOptions<UpdateOrderByChargeIdData, FirebaseError, UpdateOrderByChargeIdVariables | void>): UseMutationResult<FlattenedMutationResult<UpdateOrderByChargeIdData, UpdateOrderByChargeIdVariables>, FirebaseError, UpdateOrderByChargeIdVariables | void>;
export function useUpdateOrderByChargeId(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateOrderByChargeIdData, FirebaseError, UpdateOrderByChargeIdVariables | void>): UseMutationResult<FlattenedMutationResult<UpdateOrderByChargeIdData, UpdateOrderByChargeIdVariables>, FirebaseError, UpdateOrderByChargeIdVariables | void>;

export function useCreateOrderItem(options?: useDataConnectMutationOptions<CreateOrderItemData, FirebaseError, CreateOrderItemVariables>): UseMutationResult<FlattenedMutationResult<CreateOrderItemData, CreateOrderItemVariables>, FirebaseError, CreateOrderItemVariables>;
export function useCreateOrderItem(dc: DataConnect, options?: useDataConnectMutationOptions<CreateOrderItemData, FirebaseError, CreateOrderItemVariables>): UseMutationResult<FlattenedMutationResult<CreateOrderItemData, CreateOrderItemVariables>, FirebaseError, CreateOrderItemVariables>;
